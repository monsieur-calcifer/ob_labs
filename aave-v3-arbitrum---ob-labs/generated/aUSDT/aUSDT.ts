...
export class aUSDT__getScaledUserBalanceAndSupplyResult {
  value0: BigInt;
  value1: BigInt;
...
export class aUSDT extends ethereum.SmartContract {
  static bind(address: Address): aUSDT {
    return new aUSDT("aUSDT", address);
  }
  ...
  getScaledUserBalanceAndSupply(
    user: Address,
  ): aUSDT__getScaledUserBalanceAndSupplyResult {
    let result = super.call(
      "getScaledUserBalanceAndSupply",
    ...
    return new aUSDT__getScaledUserBalanceAndSupplyResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_getScaledUserBalanceAndSupply(
    user: Address,
  ): ethereum.CallResult<aUSDT__getScaledUserBalanceAndSupplyResult> {
    let result = super.tryCall(
      "getScaledUserBalanceAndSupply",
      "getScaledUserBalanceAndSupply(address):(uint256,uint256)",
      [ethereum.Value.fromAddress(user)],
    ...
    return ethereum.CallResult.fromValue(
      new aUSDT__getScaledUserBalanceAndSupplyResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
