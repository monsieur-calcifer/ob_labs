...
export class aUSDC__getScaledUserBalanceAndSupplyResult {
  value0: BigInt;
  value1: BigInt;
...
export class aUSDC extends ethereum.SmartContract {
  static bind(address: Address): aUSDC {
    return new aUSDC("aUSDC", address);
  }
  ...
  getScaledUserBalanceAndSupply(
    user: Address,
  ): aUSDC__getScaledUserBalanceAndSupplyResult {
    let result = super.call(
      "getScaledUserBalanceAndSupply",
    ...
    return new aUSDC__getScaledUserBalanceAndSupplyResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_getScaledUserBalanceAndSupply(
    user: Address,
  ): ethereum.CallResult<aUSDC__getScaledUserBalanceAndSupplyResult> {
    let result = super.tryCall(
      "getScaledUserBalanceAndSupply",
      "getScaledUserBalanceAndSupply(address):(uint256,uint256)",
      [ethereum.Value.fromAddress(user)],
    ...
    return ethereum.CallResult.fromValue(
      new aUSDC__getScaledUserBalanceAndSupplyResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
